...
public class Inststion {
	...
	// 张来遇写的用于存储多个维修详情集合
	private List<Wxxq> Wxxq;

	// 张来遇写的用于存储单个救援记录
	private Workcardesc Workcardesc;
	...
	public Workcardesc getWorkcardesc() {
		return Workcardesc;
	}

	public void setWorkcardesc(Workcardesc workcardesc) {
		Workcardesc = workcardesc;
	}
	...
	public void setZjy(String zjy) {
		this.zjy = zjy == null ? null : zjy.trim();
	}
